...
This document is available as an [[http://doc.norang.ca/org-mode.org][org file]] which is a text file and can be edited in GNU Emacs, and also an html file which is the output of that org file and  exported via GNU Emacs Org-Mode.
...
- Download the org-file and save it to for example =c\temp\org-mode-template.org=.
