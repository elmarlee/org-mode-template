...
- Right click [[https://raw.githubusercontent.com/elmarlee/org-mode-template/master/org-mode-template.org][the org-file]] and save it to for example =c\temp\org-mode-template.org=.
